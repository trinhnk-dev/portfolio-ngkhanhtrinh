    ...
    <div className="container" id="about">
      <div className=" py-32">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="ml-2 w-2/6 text-right">
            <Animated
              animationIn="fadeIn"
              isVisible={true}
              animationInDuration={1500}
            ...
            >
              <p className="text-lg">
                ...
                creativity, layout and analysis capabilities. Team player with
                an eye for detail. With a background of playing musical
                instruments for 7 years, I believe my mission is to combine and
                express art through code.
              </p>
            </Animated>
          </div>
        </div>
